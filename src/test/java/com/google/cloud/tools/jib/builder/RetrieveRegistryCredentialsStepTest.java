...
public class RetrieveRegistryCredentialsStepTest {
    ...
    @Mock
    private BuildLogger mockBuildLogger;

    @Mock
    private DockerCredentialHelperFactory mockDockerCredentialHelperFactory;

    @Mock
    private DockerCredentialHelper mockDockerCredentialHelper;
     ...
     */
    @Mock
    private DockerCredentialHelper mockNonexistentServerUrlDockerCredentialHelper;
     ...
     */
    @Mock
    private DockerCredentialHelper mockNonexistentDockerCredentialHelper;
    ...
    @Mock
    private NonexistentServerUrlDockerCredentialHelperException mockNonexistentServerUrlDockerCredentialHelperException;
