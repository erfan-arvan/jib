...
public class BlobCheckerTest {
    ...
    public void testHandleResponse_noContentLength() {
        ...
        try {
            ...
            Assert.assertThat(ex.getMessage(), CoreMatchers.containsString("Did not receive Content-Length header"));
        }
    }
    ...
    public void testGetApiRoute() throws MalformedURLException {
        Assert.assertEquals(new URL("http://someApiBase/someImageName/blobs/" + fakeDigest), testBlobChecker.getApiRoute("http://someApiBase/"));
    }
    ...
    public void testGetActionDescription() {
        Assert.assertEquals("check BLOB exists for someServerUrl/someImageName with digest " + fakeDigest, testBlobChecker.getActionDescription());
    }
